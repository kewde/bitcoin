...
int CTrezorDevice::OpenIfUnlocked(std::string& sError)
{
    ...
    if (0 != CTrezorDevice::WriteV1(hw::trezor::messages::MessageType_Initialize, vec_init)) {
        Close();
...
int CTrezorDevice::GetFirmwareVersion(std::string& sFirmware, std::string& sError)
{
    ...
    if (0 != CTrezorDevice::WriteV1(hw::trezor::messages::MessageType_GetFeatures, vec_in)) {
        Close();
...
int CTrezorDevice::GetPubKey(const std::vector<uint32_t>& vPath, CPubKey& pk, std::string& sError)
{
    ...
    if (0 != CTrezorDevice::WriteV1(hw::trezor::messages::MessageType_GetPublicKey, vec_in)) {
        Close();
        return errorN(1, sError, __func__, "WriteV1 failed.");
    }
...
int CTrezorDevice::SignMessage(const std::vector<uint32_t>& vPath, const std::string& sMessage, std::vector<uint8_t>& vchSig, std::string& sError)
{
    ...
    if (0 != CTrezorDevice::WriteV1(hw::trezor::messages::MessageType_SignMessage, vec_in)) {
        Close();
        return errorN(1, sError, __func__, "WriteV1 failed.");
    }
    ...
    if (0 != CTrezorDevice::WriteV1(hw::trezor::messages::MessageType_ButtonAck, vec_in)) {
        Close();
        return errorN(1, sError, __func__, "WriteV1 failed.");
    }
...
int CTrezorDevice::CompleteTransaction(CMutableTransaction* tx)
{
    ...
    if (0 != CTrezorDevice::WriteV1(hw::trezor::messages::MessageType_SignTx, vec_in)) {
        return errorN(1, sError, __func__, "WriteV1 failed.");
    }
    ...
    for (;;) {
        ...
        if (0 != CTrezorDevice::WriteV1(hw::trezor::messages::MessageType_TxAck, vec_in)) {
            return errorN(1, sError, __func__, "WriteV1 failed.");
        }
    }
...
int CTrezorDevice::LoadMnemonic(uint32_t wordcount, bool pinprotection, std::string& sError)
{
    ...
    if (0 != CTrezorDevice::WriteV1(hw::trezor::messages::MessageType_RecoveryDevice, vec_in)) {
        Close();
        return errorN(1, sError, __func__, "WriteV1 failed.");
    }
...
int CTrezorDevice::Backup(std::string& sError)
{
    ...
    if (0 != CTrezorDevice::WriteV1(hw::trezor::messages::MessageType_BackupDevice, vec_in)) {
        Close();
        return errorN(1, sError, __func__, "WriteV1 failed.");
    }
...
int CTrezorDevice::PromptUnlock(std::string& sError)
{
    ...
    if (0 != CTrezorDevice::WriteV1(hw::trezor::messages::MessageType_Ping, vec_in)) {
        Close();
        return errorN(1, sError, __func__, "WriteV1 failed.");
    }
...
int CTrezorDevice::GenericUnlock(std::vector<uint8_t>* vec_in, uint16_t msg_type_in) {
    ...
    if (0 != CTrezorDevice::WriteV1(msg_type_in, *vec_in)) {
        Close();
        return errorN(1, sError, __func__, "WriteV1 failed.");
    }
